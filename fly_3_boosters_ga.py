...
from genetic import GeneticAlgorithm, Param
...
def fitness(params):
    try:
        traces = rocket_architectures.sim_rocket_with_boosters(**params)
...
traces = rocket_architectures.sim_rocket_with_boosters(**best_params)
